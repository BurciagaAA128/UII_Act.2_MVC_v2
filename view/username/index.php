...
?>
<div class="mb-3">
    <a href="/proyecto/view/username/create.php" class="btn btn-primary">Agregar nueva bebida</a>
</div>
<table class="table">
    <thead>
        <tr>
        ...
        <?php if($rows): ?>
            <?php foreach($rows as $row): ?>
                <tr>
                    ...
                    <th><?= $row[5] ?></th>
                    <th><?= $row[6] ?></th>
                    <th><img src="data:image/jpeg;base64,<?= base64_encode($row[7]) ?>" alt="Imagen" style="max-width: 100px; max-height: 100px;" /></th>
                    <th>
